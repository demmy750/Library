  ...
  return (
    <div >
        ...
        <div className='text-[25px] font-bold'>Change Password</div>
          ...
          <div>
          <label htmlFor="password" className='border-[0.1rem]  border-white rounded-md justify-center flex  w-fit text-[0.7rem] py-[0.2rem] px-[0.8rem] font-bold ml-6 relative z-100 bg-[#FCFCFD] mt-4' >OLD PASSWORD </label>
          <input className='border w-1/2 p-[1.1rem] rounded-md  z-10  mt-[-0.8rem]' type='password' id="password" name="Old Password" placeholder="Password" />
          </div>
          <div>
          ...
          <input className='border w-1/2 p-[1.1rem] rounded-md  z-10  mt-[-0.8rem]' type='password' id="password" name="Old Password" placeholder="Password" />
            ...
            <button className='bg-[#518C36] mt-20  py-2 w-1/2 text-white rounded-lg ' type='submit'>Save Changes</button>
          </div>
